...
const categorySchema = Yup.object({
  ...
  cover: Yup.mixed().required('Viršelis yra privalomas'),
  slug: Yup.string().required('Nuorodos pavadinimas yra privalomas'),
  ...
  parentCategory: Yup.string().required('Kategorija yra privaloma'),
});

export default function SubCategoryForm({ currentCategory, categories }) {
  const router = useRouter();

  const { mutate, isPending } = useMutation({
    mutationFn: currentCategory
      ? api.updateSubCategoryByAdmin
      : api.addSubCategoryByAdmin,
    retry: false,
    onSuccess: (data) => {
      ...
      <div className='grid grid-cols-1 md:grid-cols-12 gap-6 '>
        <Card className='col-span-12 md:col-span-7 space-y-5 p-5'>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
            <div>
              <Label htmlFor='name'>Subkategorijos pavadinimas</Label>
              <Input
                id='name'
                name='name'
                placeholder='Įveskite subkategorijos pavadinimą'
            ...
            <div>
              ...
              <Input
                ...
                placeholder='Įveskite meta pavadinimą'
            ...
            <div>
              ...
              <Input
                id='slug'
                name='slug'
                placeholder='automatiškai sugeneruotas slug'
          ...
          <div>
            ...
            <Textarea
              ...
              name='description'
              rows={3}
              placeholder='Įveskite subkategorijos aprašymą...'
        ...
        <Card className='col-span-12 md:col-span-5 space-y-5 p-5'>
          ...
          <Button
            ...
            className='w-full'
            disabled={isPending}>
            {isPending ? 'Išsaugoma...' : 'Išsaugoti subkategoriją'}
          </Button>
        </Card>
      </div>
    </form>
